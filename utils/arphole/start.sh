...
export ARPHOLE_PROBE_COUNT ARPHOLE_PROBE_TIMEOUT
...
echo "arphole: iface=$ARPHOLE_IFACE threshold=$ARPHOLE_THRESHOLD window=${ARPHOLE_WINDOW}s probe=${ARPHOLE_PROBE_COUNT}x${ARPHOLE_PROBE_TIMEOUT}s workers=$ARPHOLE_WORKERS vlans=${ARPHOLE_VLANS:-all}"
exec "$PY" ./arphole.py "$@"
