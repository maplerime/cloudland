...
func (v *FloatingIpView) List(c *macaron.Context, store session.Store) {
	...
	listConfig := GetListConfig("floatingips")
	...
	c.Data["ListName"] = "floatingips"
	// Floating IPs table columns: Address, Instance, Subnet, Status, CreatedAt, Action
	c.Data["DefaultColumnsJSON"] = `["Address", "Instance", "Subnet", "Status", "CreatedAt", "Action"]`
	c.Data["AvailableColumns"] = []string{"Address", "Instance", "Subnet", "Status", "CreatedAt", "Action"}
