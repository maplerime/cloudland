...
func New() (m *macaron.Macaron) {
	...
	m.Get("/instances/search.json", instanceView.SearchJSON)
	...
	m.Get("/images/:id/export", imageView.ExportNew)
	m.Post("/images/:id/export", imageView.Export)
	...
	m.Post("/volumes/:id/export", volumeView.Export)
	...
	m.Get("/api_keys", apiKeyView.List)
	m.Get("/api_keys/new", apiKeyView.New)
	m.Post("/api_keys/new", apiKeyView.Create)
	m.Get("/api_keys/:id", apiKeyView.Edit)
	m.Post("/api_keys/:id", apiKeyView.Patch)
	m.Delete("/api_keys/:id", apiKeyView.Delete)
	...
	*/
	...
	m.Get("/secgroups/search.json", secgroupView.SearchJSON)
