...
func runInstanceOperation(ctx context.Context, task *model.ScheduledTask) error {
	...
	case "start":
		...
		err = instanceAdmin.Update(ctx, instance, nil, instance.Hostname, Start, int(instance.Hyper))
	case "stop":
		logger.Debug("[Scheduler] Executing stop operation")
		err = instanceAdmin.Update(ctx, instance, nil, instance.Hostname, Stop, int(instance.Hyper))
	case "hard_stop":
		logger.Debug("[Scheduler] Executing hard_stop operation")
		err = instanceAdmin.Update(ctx, instance, nil, instance.Hostname, HardStop, int(instance.Hyper))
	case "restart":
		logger.Debug("[Scheduler] Executing restart operation")
		err = instanceAdmin.Update(ctx, instance, nil, instance.Hostname, Restart, int(instance.Hyper))
	case "hard_restart":
		logger.Debug("[Scheduler] Executing hard_restart operation")
		err = instanceAdmin.Update(ctx, instance, nil, instance.Hostname, HardRestart, int(instance.Hyper))
	default:
