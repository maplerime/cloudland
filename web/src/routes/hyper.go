...
func (v *HyperView) List(c *macaron.Context, store session.Store) {
	...
	SetPaginationData(c, "hypers", total, limit, offset, listConfig,
		`["Hostid", "Hostname", "Parentid", "CpuModel", "OS", "HostIP", "RouteIP", "Status", "Zone", "Cpu", "Memory", "Disk", "CpuLoad", "Hugepages", "OverCommitRates", "Remark", "Action"]`,
		[]string{"Hostid", "Hostname", "Parentid", "CpuModel", "OS", "HostIP", "RouteIP", "Status", "Zone", "Cpu", "Memory", "Disk", "CpuLoad", "Hugepages", "OverCommitRates", "Remark", "Action"})
