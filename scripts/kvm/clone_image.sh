...
log_debug "wds test" "ID : $ID, prefix: $prefix, target_pool_ID: $target_pool_ID, storage_ID: $storage_ID, source_image: $source_image, target_image: $target_image"
...
log_debug "wds test" "source_volume_id: $source_volume_id"
...
log_debug "wds test" "clone_ret: $clone_ret"
...
for i in {1..100}; do
    ...
    log_debug "wds test" "task_state: $st"
